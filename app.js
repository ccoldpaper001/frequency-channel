...
const TOOLBOX_SCRIPTS = ["tb-svg-icons.js","tb-config.js","tb-utils.js","tb-editor.js","tb-ai.js","tb-memory.js","tb-api.js","tb-search.js","tb-prompt-db.js","tb-replace.js","tb-sidebar-sort.js","tb-htmledit.js","tb-svg-converter.js","tb-app.js"].map(f => f + "?v=20260822-23");
...
async function ensureToolbox(page) {
  if (!toolboxLoading) {
    toolboxLoading = (async () => {
      ...
      await loadScript("tb-storage.js?v=20260822-23");
